...
<div id="etusivu" class="container-fluid p-0 mb-4">
  ...
  >
    <div class="container py-5">
      <h1 class="display-3 fong-weight-bold drop-shadow" style="text-shadow: 2px 2px 8px rgba(0, 0, 0, 0.7)">Villa Leppäranta</h1>

      <p class="lead my-3 font-weight-normal" style="text-shadow: 2px 2px 8px rgba(0, 0, 0, 0.8); font-size: 1.5rem">
        Luonnonrauhaa Simplelejärven rannalla Parikkalassa
      </p>
      <!-- prettier-ignore -->
      <a href="#" class="btn btn-primary btn-lg mt-4 px-4 py-3 font-weight-bold shadow" onclick="SkrollaaOsioon('kalenteri');false;">
        Katso vapaat ajat
      </a>
    </div>
  </div>
...
<div id="varustelu" class="container-fluid mb-4">
  ...
  <div class="col-6 col-md-3 p-1">
      <img src="Assets/Terassi.jpg" alt="Mökin terassi ja riippukeinu" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
    <div class="col-6 col-md-3 p-1">
      <img src="Assets/Etupiha.jpg" alt="Näkymä järvelle kesällä" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
      <div class="col-6 col-md-3 p-1">
      <img src="Assets/Keittio_m.jpg" alt="Keittiönurkkaus" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
      <div class="col-6 col-md-3 p-1">
      <img src="Assets/Ruokailutila_s.jpg" alt="Ruokailutila" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
     <div class="col-6 col-md-3 p-1">
      <img src="Assets/Ruokapoyta_s.jpg" alt="Ruokailutila" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
      <div class="col-6 col-md-3 p-1">
      <img src="Assets/WC_m.jpg" alt="Sisä WC" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
       <div class="col-6 col-md-3 p-1">
      <img src="Assets/WC2.jpg" alt="Käsienpesupaikka" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
        <div class="col-6 col-md-3 p-1">
      <img src="Assets/Pesutila_s.jpg" alt="Pesutilat" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
        <div class="col-6 col-md-3 p-1">
      <img src="Assets/Suihku_s.jpg" alt="Suihkutilat" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
        <div class="col-6 col-md-3 p-1">
      <img src="Assets/Sauna_m.jpg" alt="Pieni tunnelmallinen sauna" 
      class="img-fluid w-100" style="height: 160px; object-fit: cover;">
    </div>
...
function LataaAloitusSisalto() {
  document.getElementById("kontentti").innerHTML = etusivuHTML + 
  varusteluHTML + 
  alueHTML + 
  yhteydenottoHTML + 
  kalenteriHTML;
